...
var _ webhook.CustomDefaulter = &HostProfile{}

// Default implements webhook.Defaulter so a webhook will be registered for the type
func (r *HostProfile) Default(ctx context.Context, obj runtime.Object) error {
...
var _ webhook.CustomValidator = &HostProfile{}

// ValidateCreate implements webhook.Validator so a webhook will be registered for the type
func (r *HostProfile) ValidateCreate(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	hostprofilelog.Info("validate create", "name", r.Name)

	// TODO(user): fill in your validation logic upon object creation.
	return nil, r.validateHostProfile()
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type
func (r *HostProfile) ValidateUpdate(ctx context.Context, old runtime.Object, new runtime.Object) (admission.Warnings, error) {
...
func (r *HostProfile) ValidateDelete(ctx context.Context, old runtime.Object) (admission.Warnings, error) {
